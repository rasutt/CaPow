# Robin Aldridge-Sutton 10/02/20
# This is a version of capow-fast, capow with Robin's modifications for speed, that is has been modified to use TMB.
# The negative log likelihood is calculated in C++ in popan.cpp, which is compiled and linked at the top of this script.
# It is important to remember not to distribute the compiled files with the code as they are machine specific and will
# not be recompiled if they are already there.
